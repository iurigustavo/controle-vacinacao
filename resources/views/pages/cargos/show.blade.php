...
@section('content')
    ...
    <div class="card card-custom">
        ...
        @if($model->id > 0)
            {!! Form::open(['url' => route('cargos.update',$model->id), 'id'=>'validate', 'method' => 'put']) !!}
        @else
            {!! Form::open(['url' => route('cargos.store'), 'id' => 'validate']) !!}
        @endif
        <div class="card-body">
        ...
        <div class="card-footer">
            ...
            <a href="{!! route('cargos.index') !!}" class="btn btn-danger font-weight-bolder text-uppercase">Voltar</a>
        </div>
        {!! Form::close() !!}
    </div>
@endsection