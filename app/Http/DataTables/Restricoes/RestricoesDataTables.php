<?php
    ...
    namespace App\Http\DataTables\Restricoes;
    ...
    class RestricoesDataTables extends DataTable
    {
        /**
        ...
        public function dataTable($query)
        {
            return datatables()
                ...
                ->addColumn('action', function ($q) {
                    return DataTablesUtils::btnShow('restricoes.show', $q->id);
                })
                ->rawColumns([
                    'action',
                ])
         ...
         */
        public function query(Restricao $model)
        {
